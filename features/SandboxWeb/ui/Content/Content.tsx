...
export const Content: FC = () => {
  ...
  const changeAllCode = (key: keyof IWebCode, value: string) => {
    dispatch(sandboxWebAction.setAllCode({ key, value }))
  }
  ...
  const collapseSection = (section: SectionTypes) => {
    dispatch(sandboxWebAction.setCurrent(section))
  }
          ...
          <div ref={htmlRef} className={classNames(cls.codeSection, {}, [cls.transition])}>
            <div className={cls.codeWrapper}>
              ...
              <CodeEditor
                ...
                onChange={(value) => {
                  debounce('html', value)
                  dispatch(sandboxWebAction.setCode({ key: 'html', value }))
                }}
                language="html"
