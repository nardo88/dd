var PHP = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    ;[
      ...
      '_php_embed_shutdown',
      '_zend_eval_string',
      '_vrzno_expose_inc_zrefcount',
      '_vrzno_expose_dec_zrefcount',
      '_vrzno_expose_zrefcount',
      '_vrzno_expose_inc_crefcount',
      '_vrzno_expose_dec_crefcount',
      '_vrzno_expose_crefcount',
      '_vrzno_expose_efree',
      '_vrzno_expose_create_bool',
      '_vrzno_expose_create_null',
      '_vrzno_expose_create_undef',
      '_vrzno_expose_create_long',
      '_vrzno_expose_create_double',
      '_vrzno_expose_create_string',
      '_vrzno_expose_create_object_for_target',
      '_vrzno_expose_create_params',
      '_vrzno_expose_set_param',
      '_vrzno_expose_zval_is_target',
      '_vrzno_expose_object_keys',
      '_vrzno_expose_zval_dump',
      '_vrzno_expose_type',
      '_vrzno_expose_callable',
      '_vrzno_expose_long',
      '_vrzno_expose_double',
      '_vrzno_expose_string',
      '_vrzno_expose_property_pointer',
      '_vrzno_exec_callback',
      '_vrzno_del_callback',
      '_fflush',
      '_pib_tokenize',
      '_exec_callback',
    ...
    Module.PdoD1Driver =
      ...
      class PdoD1Driver {
        prepare(db, query) {
          console.log('prepare', { db: db, query: query })
          return db.prepare(query)
        }
        doer(db, query) {
          console.log('doer', { db: db, query: query })
        }
      }
    ...
    var ASM_CONSTS = {
      ...
      3572916: ($0) =>
        !!(Module.targets.get($0).prototype && Module.targets.get($0).prototype.constructor),
      3573017: ($0, $1, $2) => {
        ;(() => {
          const target = Module.targets.get($0)
          const property = UTF8ToString($1)
    ...
    var _vrzno_expose_inc_zrefcount = (Module['_vrzno_expose_inc_zrefcount'] = createExportWrapper(
      'vrzno_expose_inc_zrefcount'
    ))
    var _vrzno_expose_dec_zrefcount = (Module['_vrzno_expose_dec_zrefcount'] = createExportWrapper(
      'vrzno_expose_dec_zrefcount'
    ))
    var _vrzno_expose_zrefcount = (Module['_vrzno_expose_zrefcount'] =
      createExportWrapper('vrzno_expose_zrefcount'))
    var _vrzno_expose_inc_crefcount = (Module['_vrzno_expose_inc_crefcount'] = createExportWrapper(
      'vrzno_expose_inc_crefcount'
    ))
    var _vrzno_expose_dec_crefcount = (Module['_vrzno_expose_dec_crefcount'] = createExportWrapper(
      'vrzno_expose_dec_crefcount'
    ))
    var _vrzno_expose_crefcount = (Module['_vrzno_expose_crefcount'] =
      createExportWrapper('vrzno_expose_crefcount'))
    var _vrzno_expose_efree = (Module['_vrzno_expose_efree'] =
      createExportWrapper('vrzno_expose_efree'))
    var _vrzno_expose_create_bool = (Module['_vrzno_expose_create_bool'] = createExportWrapper(
      'vrzno_expose_create_bool'
    ))
    var _vrzno_expose_create_null = (Module['_vrzno_expose_create_null'] = createExportWrapper(
      'vrzno_expose_create_null'
    ))
    var _vrzno_expose_create_undef = (Module['_vrzno_expose_create_undef'] = createExportWrapper(
      'vrzno_expose_create_undef'
    ))
    var _vrzno_expose_create_long = (Module['_vrzno_expose_create_long'] = createExportWrapper(
      'vrzno_expose_create_long'
    ))
    var _vrzno_expose_create_double = (Module['_vrzno_expose_create_double'] = createExportWrapper(
      'vrzno_expose_create_double'
    ))
    var _vrzno_expose_create_string = (Module['_vrzno_expose_create_string'] = createExportWrapper(
      'vrzno_expose_create_string'
    ))
    var _vrzno_expose_create_object_for_target = (Module['_vrzno_expose_create_object_for_target'] =
      createExportWrapper('vrzno_expose_create_object_for_target'))
    var _vrzno_expose_create_params = (Module['_vrzno_expose_create_params'] = createExportWrapper(
      'vrzno_expose_create_params'
    ))
    var _vrzno_expose_set_param = (Module['_vrzno_expose_set_param'] =
      createExportWrapper('vrzno_expose_set_param'))
    var _vrzno_expose_zval_is_target = (Module['_vrzno_expose_zval_is_target'] =
      createExportWrapper('vrzno_expose_zval_is_target'))
    var _vrzno_expose_object_keys = (Module['_vrzno_expose_object_keys'] = createExportWrapper(
      'vrzno_expose_object_keys'
    ))
    var _vrzno_expose_zval_dump = (Module['_vrzno_expose_zval_dump'] =
      createExportWrapper('vrzno_expose_zval_dump'))
    var _vrzno_expose_type = (Module['_vrzno_expose_type'] =
      createExportWrapper('vrzno_expose_type'))
    var _vrzno_expose_callable = (Module['_vrzno_expose_callable'] =
      createExportWrapper('vrzno_expose_callable'))
    var _vrzno_expose_long = (Module['_vrzno_expose_long'] =
      createExportWrapper('vrzno_expose_long'))
    var _vrzno_expose_double = (Module['_vrzno_expose_double'] =
      createExportWrapper('vrzno_expose_double'))
    var _vrzno_expose_string = (Module['_vrzno_expose_string'] =
      createExportWrapper('vrzno_expose_string'))
    var _vrzno_expose_property_pointer = (Module['_vrzno_expose_property_pointer'] =
      createExportWrapper('vrzno_expose_property_pointer'))
    var _vrzno_exec_callback = (Module['_vrzno_exec_callback'] =
      createExportWrapper('vrzno_exec_callback'))
    var _vrzno_del_callback = (Module['_vrzno_del_callback'] =
      createExportWrapper('vrzno_del_callback'))
    ...
    var _php_embed_shutdown = (Module['_php_embed_shutdown'] =
      createExportWrapper('php_embed_shutdown'))
    ...
    function applySignatureConversions(exports) {
      ...
      exports['emscripten_builtin_memalign'] = makeWrapper_ppp(
        exports['emscripten_builtin_memalign']
      )
      ...
      exports['emscripten_stack_get_current'] = makeWrapper_p(
